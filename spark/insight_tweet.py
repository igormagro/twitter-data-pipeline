...
if __name__ == "__main__":
    ...
    tweet = spark.read.json(
        "/home/ibernardes/datapipeline/datalake/silver/twitter_aluraonline/tweet")
    ...
    tweet = tweet.alias("tweet")\
        ...
        .agg(
            countDistinct("id").alias("n_tweet"),
    ...
    tweet.coalesce(1)\
        .write\
        .json("/home/ibernardes/datapipeline/datalake/gold/twitter_insigth_tweet")
